...
<body>
    ...
    <div class="container">
        <ul class="nav nav-pills justify-content-center">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">Método
                    Pago</a>
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" id="mostrarMetodosPago">Mostrar</a></li>
                    <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#miModalMetodoPago">Agregar</a>
                    </li>
                </ul>
            </li>
        ...
        <div id="misCategoriasAdmin">
            ...
            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                ...
                <div class="d-flex flex-row justify-content-between p-2">
                    <small class="text-muted p-1">Num. Cursos: 5</small>
                    <small class="text-muted p-1">8:35pm 22/Feb/2023</small>
                </div>
            </a>
            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                <div class="miImagen misMensajes d-flex w-100 justify-content-between">
        ...
        <div id="misMetodosPago">
            <hr class="solid">
            <a href="#" class="p-4 list-group-item list-group-item-action" aria-current="true">
