...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`categoria` (
  ...
  INDEX `FK_Categoria_Usuario` (`Usuario_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`curso` (
  ...
  INDEX `FK_Curso_Usuario` (`Usuario_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`comentariocurso` (
  ...
  INDEX `FK_ComentarioCurso_Usuario` (`Usuario_id` ASC) VISIBLE,
  INDEX `FK_ComentarioCurso_Curso` (`Curso_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`cursocategoria` (
  ...
  INDEX `FK_CursoCategoria_Categoria` (`Categoria_id` ASC) VISIBLE,
  INDEX `FK_CursoCategoria_Curso` (`Curso_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`mensaje` (
  ...
  INDEX `FK_Mensaje_UsuarioInstructor` (`UsuarioInstructor_id` ASC) VISIBLE,
  INDEX `FK_Mensaje_UsuarioAlumno` (`UsuarioAlumno_id` ASC) VISIBLE,
  INDEX `FK_Mensaje_Curso` (`Curso_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`mensajedetalle` (
  ...
  INDEX `FK_MensajeDetalle_Usuario` (`Usuario_id` ASC) VISIBLE,
  INDEX `FK_MensajeDetalle_Mensaje_id` (`Mensaje_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`nivel` (
  ...
  INDEX `FK_Nivel_Curso` (`Curso_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`multimedia` (
  ...
  INDEX `FK_Multimedia_Nivel` (`Nivel_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`usuariocurso` (
  ...
  INDEX `FK_usuarioCurso_MetodoPago` (`MetodoPago_id` ASC) VISIBLE,
  INDEX `FK_usuarioCurso_Curso` (`Curso_id` ASC) VISIBLE,
  INDEX `FK_usuarioCurso_Usuario` (`Usuario_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`nivelcurso` (
  ...
  INDEX `FK_PK_nivelCurso_MetodoPago` (`MetodoPago_id` ASC) VISIBLE,
  INDEX `FK_PK_nivelCurso_Usuario` (`Usuario_id` ASC) VISIBLE,
  INDEX `FK_PK_nivelCurso_Nivel` (`Nivel_id` ASC) VISIBLE,
  INDEX `FK_nivelCurso_usuarioCurso` (`usuarioCurso_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Placeholder table for view `bdmm_proyecto`.`vcursonoborrador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdmm_proyecto`.`vcursonoborrador` (`Curso_id` INT, `Usuario_id` INT, `noNiveles` INT, `costoCurso` INT, `noComentarios` INT, `noLikes` INT, `noDislikes` INT, `imagenCurso` INT, `nombre` INT, `descripcion` INT, `isBaja` INT, `isBorrador` INT);
...
USE `bdmm_proyecto`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bdmm_proyecto`.`vcurso` AS select `bdmm_proyecto`.`curso`.`Curso_id` AS `Curso_id`,`bdmm_proyecto`.`curso`.`Usuario_id` AS `Usuario_id`,`bdmm_proyecto`.`curso`.`noNiveles` AS `noNiveles`,`bdmm_proyecto`.`curso`.`costoCurso` AS `costoCurso`,`bdmm_proyecto`.`curso`.`noComentarios` AS `noComentarios`,`bdmm_proyecto`.`curso`.`noLikes` AS `noLikes`,`bdmm_proyecto`.`curso`.`noDislikes` AS `noDislikes`,`bdmm_proyecto`.`curso`.`imagenCurso` AS `imagenCurso`,`bdmm_proyecto`.`curso`.`nombre` AS `nombre`,`bdmm_proyecto`.`curso`.`descripcion` AS `descripcion`,`bdmm_proyecto`.`curso`.`isBaja` AS `isBaja`,`bdmm_proyecto`.`curso`.`isBorrador` AS `isBorrador` from `bdmm_proyecto`.`curso`;
...
-- -----------------------------------------------------
-- View `bdmm_proyecto`.`vcursonoborrador`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bdmm_proyecto`.`vcursonoborrador`;
USE `bdmm_proyecto`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bdmm_proyecto`.`vcursonoborrador` AS select `bdmm_proyecto`.`curso`.`Curso_id` AS `Curso_id`,`bdmm_proyecto`.`curso`.`Usuario_id` AS `Usuario_id`,`bdmm_proyecto`.`curso`.`noNiveles` AS `noNiveles`,`bdmm_proyecto`.`curso`.`costoCurso` AS `costoCurso`,`bdmm_proyecto`.`curso`.`noComentarios` AS `noComentarios`,`bdmm_proyecto`.`curso`.`noLikes` AS `noLikes`,`bdmm_proyecto`.`curso`.`noDislikes` AS `noDislikes`,`bdmm_proyecto`.`curso`.`imagenCurso` AS `imagenCurso`,`bdmm_proyecto`.`curso`.`nombre` AS `nombre`,`bdmm_proyecto`.`curso`.`descripcion` AS `descripcion`,`bdmm_proyecto`.`curso`.`isBaja` AS `isBaja`,`bdmm_proyecto`.`curso`.`isBorrador` AS `isBorrador` from `bdmm_proyecto`.`curso` where (`bdmm_proyecto`.`curso`.`isBorrador` <> 1) order by `bdmm_proyecto`.`curso`.`Curso_id` desc;
