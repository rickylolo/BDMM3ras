...
CREATE TABLE Curso(
    ...
    noNiveles 			INT NOT NULL 					COMMENT'número de niveles del curso',
	costoCurso  		DECIMAL(9,2) UNSIGNED NOT NULL 	COMMENT'Costo del curso',
    noComentarios 		INT 							COMMENT'numero de comentarios del curso',
    noLikes 			INT 							COMMENT'numero de reseñas buenas del curso',
    noDislikes 			INT 							COMMENT'numero de reseñas malas del curso',
